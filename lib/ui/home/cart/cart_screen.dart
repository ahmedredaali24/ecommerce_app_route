...
class CartScreen extends StatelessWidget {
  ...
  CartViewModel viewModel = CartViewModel(
      ...
      cartUseCase: injectGetCartUseCase(),
  ...
  Widget build(BuildContext context) {
    return BlocProvider<CartViewModel>(
      ...
      child: BlocBuilder<CartViewModel, CartStates>(builder: (context, state) {
        return Scaffold(
            appBar: AppBar(
              centerTitle: true,
            ...
            body: state is CartStatesSuccessState
                ? Column(
